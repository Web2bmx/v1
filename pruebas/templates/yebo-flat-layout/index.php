...
<html lang="en">
	...
	<body>
		<header>
			<div class="container">
				<div class="row">
                                    <div class="responsive-logo" style="background: url(<?= $logo; ?>); width: <?= $ancho ?>px; height: <?= $alto ?>px">                                                                            
                                    </div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<nav>
                                                    <div class="logo-holder" style="background: url(<?= $logo; ?>); width: <?= $ancho ?>px; height: <?= $alto ?>px; left: <?= $posdesk ?>px">                                                                                                                                                                           
                                                    </div>
							<ul class="clearfix">
