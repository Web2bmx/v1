<footer>
	<div class="footer-header">
		<h3><?php echo($content->contact[0]->header[0]->title); ?></h3>
		<p><?php echo($content->contact[0]->header[0]->text); ?></p>
	</div>
	<div class="footer-contact-info">
		<div class="footer-column">	
			<h5><?php echo($content->contact[0]->communication[0]->title); ?></h5>
			<ul>
		...
		<div class="footer-column">	
			<h5><?php echo($content->contact[0]->location[0]->title); ?></h5>
			<ul>
		...
		<div class="footer-column">	
			<h5><?php echo($content->contact[0]->social[0]->title); ?></h5>
			<ul>
