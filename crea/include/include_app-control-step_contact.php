<div>
    <h2>Coloca los datos de contacto de tu Negocio</h2>
    <div class="container-input"> 
		...
		<p class="app-control-step-tooltip-info">Estos datos son opcionales y solo aquellos que coloques aparecerán en tu página web.</p>
